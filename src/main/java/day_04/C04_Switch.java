...
public class C04_Switch {
    ...
    public static void main(String[] args) {
        ...
        String seviye="";// Disarida bos konteynr acmamizin sebebi switc ve if icinde de kullanabilmemeiz icin.
                         // Eger sadece if icin seviye yapsaydik if {body} bitinceswitch de kullanamazdik.
